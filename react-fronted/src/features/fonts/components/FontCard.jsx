...
// // הזרקת אנימציות (נשימה, סיבוב ונצנוץ הצלחה)
...
//       50% { box-shadow: 0 0 20px rgba(40, 167, 69, 0.6); border-color: #28a745; }
...
//             setJustFinished(true); // מפעיל את אפקט הנצנוץ
...
//       ...(justFinished ? { border: '2px solid #28a745' } : {}),
//     }} className={justFinished ? 'animate-success' : ''}>
      
//       {/* שכבת הטשטוש וההודעה בזמן עיבוד */}
//       {isProcessing && (
//         <div style={styles.overlay}>
//           <div style={styles.spinner}>⚙️</div>
//           <div style={styles.overlayText}>ה-AI בונה פונט...</div>
//         </div>
//       )}

//       {/* תוכן הכרטיס - מטושטש רק בזמן עיבוד */}
//       <div style={{ 
...
//         <p style={styles.author}><strong>יוצר:</strong> {font.ownerName}</p>
        
//         <div style={styles.tags}>
//           {font.geometricStyle && <span style={styles.tag}>{font.geometricStyle}</span>}
//           {font.contentStyle && <span style={styles.tag}>{font.contentStyle}</span>}
//           {font.expressionStyle && <span style={styles.tag}>{font.expressionStyle}</span>}
//         </div>

//         {isFailed ? (
//           <div style={styles.errorText}>❌ העיבוד נכשל</div>
//         ) : (
//           <button 
...
//             style={{ 
//               ...styles.button, 
//               backgroundColor: isProcessing ? '#ccc' : '#2c3e50',
...
//     borderRadius: '20px'
//   },
//   title: { margin: '0 0 8px 0', fontSize: '1.2rem', color: '#1a1a1a' },
//   author: { fontSize: '0.85rem', color: '#666', marginBottom: '16px' },
//   tags: { display: 'flex', justifyContent: 'center', gap: '6px', marginBottom: '20px', flexWrap: 'wrap' },
//   tag: { backgroundColor: '#f0f2f5', padding: '3px 10px', borderRadius: '6px', fontSize: '11px', fontWeight: '500' },
//   button: { 
//     color: 'white', border: 'none', padding: '12px 20px', borderRadius: '10px', 
//     fontWeight: '600', width: '100%', transition: 'all 0.2s' 
//   },
//   errorText: { color: '#dc3545', fontWeight: 'bold', fontSize: '0.9rem', padding: '10px' }
// }

...
//       {/* שכבת ה-Overlay המאוחדת - מופיעה רק בעיבוד */}
//       {isProcessing && (
//         <div style={styles.rowOverlay}>
//           <div className="spin-icon" style={styles.spinnerIcon}>⚙️</div>
//           <span style={styles.overlayText}>ה-AI מעבד את הפונט...</span>
//         </div>
//       )}

//       {/* תוכן השורה - מיטשטש בזמן עיבוד */}
//       <div style={{ 
//         display: 'flex', 
...
//             <span>הורדות: {font.downloadCount || 0}</span>
//             <span>•</span>
//             <span>נוצר: {font.creationDate}</span>
//             <span>•</span>
//             <span style={{ fontWeight: '600' }}>
//               {font.permission === 'PUBLIC' && '🌐 Public'}
//               {font.permission === 'PRIVATE' && '🔒 Private'}
//               {font.permission === 'RESTRICTED' && '👥 Restricted'}
//             </span>
//           </div>
//         </div>
...
//           {isFailed && <span style={{ color: '#e63946', fontSize: '0.85rem' }}>נכשל</span>}

//           {/* כפתור הפח המקורי והיפה */}
//           <button 
...
//   useEffect(() => {
//     loadDashboardData();
//     // הזרקת ה-CSS של האנימציה (כדי שהגלגל יסתובב)
...
//         }
//         .spin-icon { animation: spin-slow 3s linear infinite; }
//       `;
...
//         <Link to="/create" style={styles.createBtn}>+ פונט חדש</Link>
//       </div>
...
//           {myFonts.length === 0 ? (
//             <div style={styles.emptyState}>עדיין לא יצרת פונטים.</div>
//           ) : (
//             myFonts.map(font => (
//               <FontRowItem 
//                 key={font.id} 
...
// // --- סגנונות (Styles) ---
// const styles = {
//   pageWrapper: { padding: '2rem 1rem', maxWidth: '1000px', margin: '0 auto', direction: 'rtl' },
//   header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', borderBottom: '1px solid #eee', paddingBottom: '1.5rem' },
//   mainTitle: { fontSize: '1.8rem', color: '#1a1a1a', fontWeight: '700' },
//   createBtn: { padding: '0.7rem 1.4rem', background: '#1a1a1a', color: 'white', textDecoration: 'none', borderRadius: '8px', fontSize: '0.9rem', fontWeight: '600' },
//   profileCard: { background: '#fff', padding: '2rem', borderRadius: '12px', marginBottom: '3rem', border: '1px solid #eee', boxShadow: '0 2px 10px rgba(0,0,0,0.02)' },
//   profileHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' },
//   sectionTitle: { fontSize: '1.25rem', color: '#333', fontWeight: '600' },
//   editBtn: { padding: '0.5rem 1rem', background: 'white', border: '1px solid #ddd', borderRadius: '6px', cursor: 'pointer' },
//   saveBtn: { padding: '0.5rem 1rem', background: '#1a1a1a', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' },
//   cancelBtn: { padding: '0.5rem 1rem', background: 'white', border: '1px solid #ddd', borderRadius: '6px', cursor: 'pointer' },
//   profileGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' },
//   label: { display: 'block', marginBottom: '0.5rem', color: '#666', fontSize: '0.85rem' },
//   input: { width: '100%', padding: '0.7rem', border: '1px solid #ddd', borderRadius: '6px', fontSize: '1rem' },
//   staticValue: { fontSize: '1rem', color: '#1a1a1a', padding: '0.7rem 0' },
//   disabledInput: { color: '#999', padding: '0.7rem 0' },
//   loadingScreen: { display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '400px', fontSize: '1.1rem', color: '#666' },
//   emptyState: { textAlign: 'center', padding: '3rem', color: '#999', background: '#f9f9f9', borderRadius: '12px' },
  
//   // סגנונות השורה וה-Overlay
//   rowContainer: { position: 'relative', background: 'white', padding: '1.2rem 1.5rem', borderRadius: '12px', border: '1px solid #e0e0e0', display: 'flex', alignItems: 'center', marginBottom: '1rem', overflow: 'hidden' },
//   rowOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(255, 255, 255, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 5, backdropFilter: 'blur(1px)' },
//   spinnerIcon: { fontSize: '1.2rem', marginLeft: '10px' },
//   overlayText: { fontWeight: '600', fontSize: '0.85rem', color: '#2c3e50' },
//   fontTitle: { fontSize: '1.05rem', margin: '0 0 4px 0', color: '#333', fontWeight: '600' },
//   fontDetails: { fontSize: '0.8rem', color: '#888', display: 'flex', gap: '10px' },
//   viewBtn: { padding: '0.5rem 1rem', background: '#333', color: 'white', textDecoration: 'none', borderRadius: '6px', fontSize: '0.85rem' },
//   permBtn: { padding: '0.5rem 1rem', background: 'white', border: '1px solid #ddd', borderRadius: '6px', cursor: 'pointer', fontSize: '0.85rem' },
//   // הסטייל המעודכן לכפתור המחיקה ב-Dashboard
//   deleteBtn: { 
//     width: '40px', 
//     height: '40px', 
//     display: 'flex', 
...
//     color: '#e63946', 
//     background: '#fff', 
//     border: '1px solid #f8d7da', // המסגרת שרצית
//     borderRadius: '8px', 
//     cursor: 'pointer',
//     transition: 'all 0.2s',
//     padding: '0' 
